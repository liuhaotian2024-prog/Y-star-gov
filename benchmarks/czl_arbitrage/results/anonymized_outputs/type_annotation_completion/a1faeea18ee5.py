...
from typing import Any, Callable, Dict, FrozenSet, Iterable, List, Optional, Set, TypeVar, Union
...
def filter_keys(d: Dict[K, V], allowed: Union[List[K], Set[K], FrozenSet[K]]) -> Dict[K, V]:
