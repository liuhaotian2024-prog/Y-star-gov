...
def test_load_records_top_level_int(tmp_path):
    p = tmp_path / "int.json"
...
def test_aggregate_by_domain_unknown():
    recs = [{'email': 'noat'}, {'email': 'also-no-at'}]
