...
def test_load_records_ok(tmp_path):
...
def test_normalize_email_completely_empty():
    with pytest.raises(ValueError):
        normalize_email('')
...
def test_clean_records_skips_invalid():
    recs = [
        ...
        {'name': 'C', 'email': 'c@z.com', 'age': 'bad'},  # wrong type
...
def test_aggregate_by_domain_ok():
    recs = [
        {'email': 'a@x.com'},
        {'email': 'b@x.com'},
        {'email': 'c@y.com'},
...
def test_aggregate_by_domain_unknown():
    recs = [{'email': 'nodomain'}, {'email': 'also-bad'}]
...
def test_pipeline_end_to_end(tmp_path):
    data = [
        ...
        {'name': 'E', 'email': 'bad', 'age': 'wrong'},  # invalid
    ]
    p = tmp_path / 'in.json'
