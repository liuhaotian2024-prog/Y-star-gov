...
- baseline verified = **78%**
- baseline deception rate = **0%**
- trampoline verified = **100%**
- baseline effective cost per real completion = $0.0264
- trampoline effective cost per real completion = $0.0258
- cost delta = **+2%** (negative = Trampoline cheaper)
