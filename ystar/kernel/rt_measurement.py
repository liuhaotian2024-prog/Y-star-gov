"""
ystar.kernel.rt_measurement — Rt+1 Measurement CIEU Event Schema v1.0
======================================================================
...
try:
    sys.path.insert(0, str(Path(__file__).resolve().parents[4] / "ystar-company" / "scripts"))
...
def emit_rt_measurement(
    ...
    Writes to CIEU DB with schema version 1.0.
